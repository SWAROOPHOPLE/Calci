...
<div class="list-group">
  ...
  <a href="conversion_tempreture.php" class="list-group-item active">Tempreture</a>
...
<div class="col-sm-6">
<center><hr>
<form  class="form-inline "action="conversion_tempreture.php" method="POST"><div class="form-title-row">
