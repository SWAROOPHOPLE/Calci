...
if($data[0]>=1){echo"<br><br><br><br><br><h3><center><font color='white'>Username is $no</font></center></h3>";}else {echo"Name or email is Wrong retype it";}
...
echo"<br><br><br><br><br><br><h3><center><font color='white'>Password is $no1</font></center></h3>";}
?>
...
<div class="col-sm-4" style="background-color:#C0C0C0;" id="rcorners"><br>
  ...
  <form class="form-horizontal" role="form"  method="post " action="p.php">
