...
<div class="col-sm-6">
<center><hr>
<form  class="form-inline "action="calculator_octtoall.php" method="POST"><div class="form-title-row">
...
<div class="list-group">
            ...
            <a href="calculator_octtoall.php" class="list-group-item active ">Octal to All* Calculator</a> 			
 			<h6><b><br>&nbsp;* All <br>&nbsp;&nbsp;&nbsp;= Hexadecimal , Octal , Binary <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Decimal
 			</b></h6>
