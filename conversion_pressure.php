...
<div class="list-group">
  ...
  <a href="conversion_pressure.php" class="list-group-item active">Pressure</a>
...
<div class="col-sm-6">
<center><hr>
<form class="form-inline " action="conversion_pressure.php" method="POST"><div class="form-title-row">
