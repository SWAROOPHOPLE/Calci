...
<div class="col-sm-4" id="rcorners"><br>
 <?php 
if ($_SERVER["REQUEST_METHOD"] == "POST"){
if(($data[0]>=1) &&($data1[0]>=1))
{
        ...
        mail($y, 'Study Forum Account Activation ', 'Hii '.$x.',  This message is from study forum.co.in.\n Username is = '.$no.' \n Password is = '. $no1. 'thank you for signing up please enjoy.!', 'From: hopleswaroop@gmail.com');
		header("location:login.php");
}

else{echo"<center><font color='red'>Name or email is Wrong retype it</font></center>";}
