...
<div class="col-sm-6">
<center><hr>
<form  class="form-inline" action="calculator_standard.php" method="POST"><div class="form-title-row">
...
<div class="list-group">
            <a href="calculator_standard.php" class="list-group-item active">Standard Calculator</a>
