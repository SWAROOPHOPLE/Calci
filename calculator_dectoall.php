...
<div class="col-sm-6">
<center><hr>
<form  class="form-inline "action="calculator_dectoall.php" method="POST"><div class="form-title-row">
...
<div class="list-group">
            ...
            <a href="calculator_dectoall.php" class="list-group-item active">Decimal to All* Calculator</a>
