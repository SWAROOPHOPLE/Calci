...
<div class="col-sm-6">
<center><hr>
<form class="form-inline" action="calculator_bintoall.php" method="POST"><div class="form-title-row">
...
<div class="list-group">
            ...
            <a href="calculator_bintoall.php" class="list-group-item active">Binary to All* Calculator</a>
